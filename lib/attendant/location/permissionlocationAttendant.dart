...
class Permissionlocationattendant extends StatefulWidget {
  const Permissionlocationattendant({super.key});

  @override
  State<Permissionlocationattendant> createState() =>
      _PermissionlocationattendantState();
}

class _PermissionlocationattendantState
    extends State<Permissionlocationattendant> {
  ...
  Future<void> updateUserLocation() async {
    ...
    try {
      ...
      Future.delayed(Duration(seconds: 1), () {
        Navigator.pushReplacementNamed(context, Approutes.homepageAttendant);
      });
    } catch (e) {
